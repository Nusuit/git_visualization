...
const CommitDetailModal: React.FC<CommitDetailModalProps> = ({ commit, onClose }) => {
      ...
      >
        ...
        >
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(80vh-80px)]">
            {/* Commit Hash */}
            <div className="mb-6">
              <label className="text-gray-400 text-sm font-medium mb-2 block">Commit Hash</label>
            ...
            <div className="mb-6">
              ...
              <div className="bg-dark-300 rounded-lg p-4">
                <p className="text-white text-lg font-medium leading-relaxed">{commit.message}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                <label className="text-gray-400 text-sm font-medium mb-2 block">Author</label>
            ...
            {commit.refs && commit.refs.length > 0 && (
              <div className="mb-6">
                <label className="text-gray-400 text-sm font-medium mb-2 block">References</label>
